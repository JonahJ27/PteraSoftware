...
This module contains the following functions:
    ...
    export_data: This function takes in an UnsteadyRingVortexLatticeMethodSolver,
    and exports the loads and load coefficients as a .csv file.
...
def draw(
    ...
    :param scalar_type: str or None, optional
        ...
        the Panels uniformly. It can also be "induced drag", "side force", "lift", or "differential",
        which respectively use each Panel's induced drag, side force, lift
        coefficient or the differnce between the real and simulated wing. The default value is None.
    ...
    if scalar_type is not None:
        ...
        if scalar_type not in ("induced drag", "side force", "lift"):
            raise ValueError(
                'scalar_type must be None, "induced drag", "side force", "lift".'
            )
...
def animate(
    ...
    :param scalar_type: str or None, optional
        ...
        This variable determines how to color the Panels. Setting this to None colors
        the Panels uniformly. It can also be "induced drag", "side force","lift", "difference position", "difference lift", "difference induced drag" or "difference side force",
        which respectively use each Panel's induced drag, side force, and lift
        coefficient and their difference with respect to the first Airplane. The default value is None.
