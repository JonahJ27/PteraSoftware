...
class Movement:
    ...
    def __init__(
        ...
        :param delta_time: number or None, optional
            ...
            To use a 'optitrack' type tracking file, set the value to the sampling frequency.
        ...
        :param num_steps: int or None, optional
            ...
            To use an 'optitrack' type tracking file, set the value to the number of images you have.
        """
